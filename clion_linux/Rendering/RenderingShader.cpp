...
PAG::RenderingShader::RenderingShader(): ShaderProgram()
{
}

PAG::RenderingShader::~RenderingShader()
{
}

void PAG::RenderingShader::applyActiveSubroutines()
{
...
GLuint PAG::RenderingShader::createShaderProgram(const char* filename)
{
