...
{  
    ...
    component->_vertices.insert(component->_vertices.end(), {
            VAO::Vertex { vec3(_triangle.getA().getX(), _triangle.getA().getY(), .0f) },
            VAO::Vertex { vec3(_triangle.getB().getX(), _triangle.getB().getY(), .0f) },
            VAO::Vertex { vec3(_triangle.getC().getX(), _triangle.getC().getY(), .0f) }
        });
